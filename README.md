...
A collection of coding interview questions I've come across in my career, implemented in C# on .NET 10.0 with NUnit tests.
...
| Trees | `DataStructure/BinarySearchTree.cs` | Generic binary search tree with add/remove/contains |
